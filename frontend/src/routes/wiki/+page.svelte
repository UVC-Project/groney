...
<PageWrapper title="Wiki & Help">
  <div class="text-center mb-6">
    ...
    <h2 class="text-xl font-bold text-green-500">Learn About Green Schoolyards</h2>
  </div>
...
<!-- Getting started -->
    <div class="border-l-4 border-grass-green pl-4">
      <button class="w-full flex items-center justify-between gap-2 py-2" onclick={() => (openGroeny = !openGroeny)}>
        <h3 class="font-bold text-gray-800">Getting Started</h3>
...
<!-- How to care -->
    <div class="border-l-4 border-sky-blue pl-4">
      <button class="w-full flex items-center justify-between gap-2 py-2" onclick={() => (openHowToPlay = !openHowToPlay)}>
        <h3 class="font-bold text-gray-800">How to Care for Groeny</h3>
        <span class={`text-sm transition-transform duration-200 ${openHowToPlay ? 'rotate-90' : 'rotate-0'}`}>▶️</span>
      </button>

      {#if openHowToPlay}
        <p class="text-gray-600 text-sm mt-1">
          Groeny has four needs: Thirst 💧, Hunger 🍎, Happiness 🥰, and Love 💖. Complete missions to boost these stats. Tap Groeny to give it love and increase happiness! The healthier Groeny is, the better your class score.
        </p>
      {/if}
    </div>
...
<!-- Completing Missions -->
    <div class="border-l-4 border-sunshine-yellow pl-4">
      <button
        ...
        <h3 class="font-bold text-gray-800">Completing Missions</h3>
...
<!-- Earning coins & Xp -->
    <div class="border-l-4 border-red-500 pl-4">
      <button
        ...
        <h3 class="font-bold text-gray-800">Earning Coins & XP</h3>
...
<!-- Class Leaderboard -->
    <div class="border-l-4 border-orange-500 pl-4">
      <button
        ...
        <h3 class="font-bold text-gray-800">Class Leaderboard</h3>
