...
>
  <div class="flex justify-around items-center h-16">
    {#each navItems as item}
      <a
        href={item.href}
        class="flex flex-col items-center justify-center min-w-touch-target min-h-touch-target px-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-2 focus-visible:rounded-lg"
        class:text-green-600={currentPath === item.href}
