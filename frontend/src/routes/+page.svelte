<script lang="ts">
  ...
  // Show Gif src
  $: groenySrc =
    selectedItemId && groenyGifMap[selectedItemId] ? groenyGifMap[selectedItemId] : DefaultGif;
...
<div class="container mx-auto px-4 py-10">
  ...
  <div class="flex justify-center gap-3 mb-6">
    ...
    <div class="bg-yellow-300 px-4 py-1 rounded-full font-bold text-gray-800 shadow-lg">
      🪙{coins}
    </div>
  </div>
